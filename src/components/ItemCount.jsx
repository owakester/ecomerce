...
function ItemCount(props) {
  ...
  return (
    <div className="my-8 container">
      ...
      <img className="rounded m-1 object-contain h-48 w-96 ..." src={imagen}/>
      <h3 className="text-cyan-500 text-xl">{props.producto}</h3>

        <br />

        <div class="flex flex-row  place-items-center  ">
  <div class="basis-2/5"><button
  ...
  <div class="basis-2/5">  <button
        ...
        <h3 className="text-cyan-500"> El stock son:  <span className="text-orange-400 text-lg font-bold">{props.stock}</span>  </h3>
        <div className=" text-sm text-red-700 bg-red-100 rounded-lg dark:bg-red-200 dark:text-red-800" role="alert">
