...
const CartItem = ({ item, deleteCartById }) => {
    return (
        <article className="cart-item-card">
            ...
            <span className="cart-item__qty"><strong>Cantidad:</strong> {item.contador}</span>
            <span className="cart-item__qty"><strong>Total:</strong> ${item.contador * item.price}</span>
