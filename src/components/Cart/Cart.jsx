...
<div className="pointer-events-auto w-screen max-w-md  scroll-smooth hover:scroll-auto ">
<ul>
        {cart.map((item) => (
                    ...
                    <li className="flex py-6"  key={item.id}>
                      ...
                      <div className="ml-4 flex flex-1 flex-col">
                        ...
                        <div className="flex flex-1 items-end justify-between text-sm">
                          ...
                          <div className="flex">
                            <button type="button" className="font-medium text-green-600 hover:text-indigo-500">Remove</button>
                          </div>
                        </div>
                      </div>
                    </li>
